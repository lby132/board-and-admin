...
public record AdminAccountDto(
    ...
    public static AdminAccountDto of(String username, String password, Set<RoleType> roleTypes, String email, String nickname, String memo) {
        return AdminAccountDto.of(username, password, roleTypes, email, nickname, memo, null, null, null, null);
    }
